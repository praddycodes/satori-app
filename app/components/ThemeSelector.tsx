    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <Button
          variant="outline"
          size="icon"
          className="rounded-full w-7 h-7 border border-primary/20 text-primary/20 hover:bg-primary/5 hover:text-primary/60 absolute top-3 right-3 opacity-20 hover:opacity-100 transition-opacity"
        >
      ...
      <DropdownMenuContent
        align="end"
        className="bg-background/95 backdrop-blur-sm border-primary/30 w-[200px] grid grid-cols-3 gap-1 p-2"
      >
